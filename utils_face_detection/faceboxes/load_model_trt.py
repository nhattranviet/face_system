...
import numpy as np
from utils_face_detection.faceboxes.data import cfg
from utils_face_detection.faceboxes.layers.functions.prior_box import PriorBox
from utils_face_detection.faceboxes.utils.nms_wrapper_trt import nms
#from utils.nms.py_cpu_nms import py_cpu_nms
import cv2
from utils_face_detection.faceboxes.models.faceboxes import FaceBoxes
from utils_face_detection.faceboxes.utils.box_utils import decode
from utils_face_detection.faceboxes.utils.timer import Timer
...
class face_boxes_model:
    def __init__(self):
        self.net = TRTModule()
        self.device = "cuda:{0}".format(str(DEVICE_IDX))
    ...
    def load_face_model(self):
        ...
        self.net.load_state_dict(torch.load(FB_WEIGHTS_TRT))
        # net = load_model(net, os.path.join(FB_WEIGHTS))
        # net.eval()
